...
const Silder = () => {
  return (
    <div className="px-3 mt-3">
      <div className="sliderContainer overflow-hidden md:max-h-[15em] lg:max-h-[25em] max-w-[100%] md:mx-auto">
        <div className="slider w-[100%] flex h-[100%] md:hidden lg:w-[100%]">
        ...
        <div className="slider w-[100%] h-[100%] hidden md:flex lg:w-[100%]">
