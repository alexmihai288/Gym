    ...
    <nav className='bg-lightBlue p-3 flex flex-col gap-3 md:hidden'>
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <div className='logo hidden xxs:block'>
               <Link href={"/"}><Image className='cursor-pointer w-[55px] h-[45px] object-cover' alt='logo' width={4050} height={4050} src="https://cdn.discordapp.com/attachments/724220064223592541/1077908865745702972/image.png"/></Link> 
            </div>
      ...
      <div className="searchBarContainer flex">
        ...
        <nav className='bg-lightBlue'>
          ...
          <div className='p-3 flex-col gap-4 hidden lg:flex max-w-[1300px] mx-auto'>
                <div className="flex flex-row items-center gap-4">
                  <div className='flex gap-5 w-[100%] items-center'>
                        ...
                        <div className='flex flex-col gap-2 flex-1'>
                          ...
                          <div className={`flex gap-4 ${roboto.className} text-white font-semibold justify-center`}>
